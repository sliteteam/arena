...
[![NPM](https://img.shields.io/npm/v/@slite/bull-arena.svg)](https://www.npmjs.com/package/@slite/bull-arena) [![code style: prettier](https://img.shields.io/badge/code_style-prettier-ff69b4.svg)](https://github.com/prettier/prettier) [![NPM downloads](https://img.shields.io/npm/dm/@slite/bull-arena)](https://www.npmjs.com/package/@slite/bull-arena) [![semantic-release](https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-e10079.svg)](https://github.com/semantic-release/semantic-release)
...
```js
const Arena = require('@slite/bull-arena');
...
```js
import Arena from '@slite/bull-arena';
